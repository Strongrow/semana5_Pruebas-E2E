...
### Windows
Se puede ejecutar los test con `.\node_modules\.bin\cucumber-js.cmd` o `npm test` en la linea de comandos

### Mac or Linux
Se puede ejecutar los test con `node_modules/cucumber/bin/cucumber-js`
