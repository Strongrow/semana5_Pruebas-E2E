...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Divider para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //And, se elige la opción Divider
        primaryOptionsPage.getOptionsDividerPage()
        cy.screenshot()
        cy.wait(500)

        //And, se agrega contenido
        dataMockPage.getOptionsCreateDivider()
        cy.screenshot()
        cy.wait(500)
