...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Sound Cloud para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        primaryOptionsPage.getOptionsSoundCloudPage()
        cy.screenshot()
        cy.wait(500)

        //And, se crea el contenido
        dataMockPage.getOptionsCreateSoundCloud()
        cy.screenshot()
