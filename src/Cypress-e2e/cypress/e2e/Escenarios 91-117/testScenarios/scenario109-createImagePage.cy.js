...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Imagen para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //And, se elige la opción Imagen
        primaryOptionsPage.getOptionsImagePage()
        cy.screenshot()
        cy.wait(500)

        //And, se crea el contenido
        dataMockPage.getOptionsCreateUpimage()
        cy.screenshot()
        cy.wait(500)
