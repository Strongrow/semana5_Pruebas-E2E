...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Spotify para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        primaryOptionsPage.getOptionsSpotifyPage()
        cy.screenshot()
        cy.wait(500)

        //And, se crea el contenido
        dataMockPage.getOptionsCreateSpotify()
        cy.screenshot()
