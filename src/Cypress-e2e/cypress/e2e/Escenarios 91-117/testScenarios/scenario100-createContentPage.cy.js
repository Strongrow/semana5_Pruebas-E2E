...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Contenido predeterminado para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //When, se agrega Contenido a la page
        optionsMenuPage.getContentPage()
        cy.screenshot()
        cy.wait(500)
