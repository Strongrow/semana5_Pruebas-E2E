...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Vimeo para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        primaryOptionsPage.getOptionsVimeoPage()
        cy.screenshot()
        cy.wait(500)

        //And, se crea el contenido
        dataMockPage.getOptionsCreateVimeo()
        cy.screenshot()
