...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Html para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //And, se elige la opción Html
        primaryOptionsPage.getOptionsHtmlPage()
        cy.screenshot()
        cy.wait(500)

        //And, se agrega el contenido
        dataMockPage.getOptionsCreateHtml()
        cy.screenshot()
        cy.wait(500)
