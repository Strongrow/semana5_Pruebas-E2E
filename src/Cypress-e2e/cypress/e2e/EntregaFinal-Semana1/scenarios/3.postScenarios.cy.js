...
describe("Post Scenarios", () => {
    ...
    sizes.forEach((size) => {
        ...
        it("Scenario 21: Add a non existing author", () => {
            ...
            takeCypressScreenshot(`Scenario 21: Add a non existing author${size}`);
    ...
    5414919666
       it("Scenario 22: Add invalid canonical URL to post metadata google ", () => {
           ...
           takeCypressScreenshot(`Scenario 22: Add invalid canonical URL to post metadata google${size}`);
       });
       ...
       it("Scenario 23: Add valid canonical URL to post metadata google", () => {
          ...
          // Then there is an error message on settings
          // postsPage.checkMetadataURLError().should('exist');
          takeCypressScreenshot(`Scenario 23: Add valid canonical URL to post metadata google${size}`);
       });
       ...
       it("Scenario 24: Edit a post with invalid time", () => {
           ...
           takeCypressScreenshot(`Scenario 24: Edit a post with invalid time${size}`);
       }); 
       ...
       it("Scenario 25: Edit a post with valid post time", () => {
           ...
           takeCypressScreenshot(`Scenario 25: Edit a post with valid post time${size}`);
       }); 
       ...
       it("Scenario 26: Create valid Post", () => {
          ...
          // And the user selects a random post
           ...
           takeCypressScreenshot(`Scenario 26: Create valid Post${size}`);
       ...
       it("Scenario 27: Create post with valid metatitle", () => {
           ...
           takeCypressScreenshot(`Scenario 27: Create post with valid metatitle${size}`);
       ...
       it("Scenario 28: Edit Post with Excerpt of more than 301 characters", () => {
           ...
           takeCypressScreenshot(`Scenario 28: Edit Post with Excerpt of more than 301 characters${size}`);
       });
       ...
       it("Scenario 29: Add valid injected code at header from post settings", () => {
           ...
           takeCypressScreenshot(`Scenario 29: Add valid injected code at header from post settings${size}`);
       });
       ...
       it("Scenario 30: Create post with invalid metatitle", () => {
           ...
           takeCypressScreenshot(`Scenario 30: Create post with invalid metatitle${size}`);
       });
    ...
    it("Scenario 31: Edit a post with invalid date", () => {
       ...
       takeCypressScreenshot(`Scenario 31: Edit a post with invalid date${size}`);
    }); 
        ...
        it("Scenario 32: Edit a post with invalid tier", () => {
         ...
         // Then the edited post is displayed in the post a message error
         postsPage.checkAuthorError().should('exist');
         takeCypressScreenshot(`Scenario 32: Edit a post with invalid tier${size}`);
    }); 
    ...
    it("Scenario 33: Edit Post with x descripcion of more than 500 characters", () => {
       ...
       takeCypressScreenshot(`Scenario 33: Edit Post with x descripcion of more than 500 characters${size}`);
    ...
    it("Scenario 34: Edit Post with Facebook description of more than 500 characters", () => {
      ...
      takeCypressScreenshot(`Scenario 34: Edit Post with Facebook description of more than 500 characters${size}`);
    ...
    it("Scenario 35: Edit Post with x title of more than 301 characters", () => {
      ...
      takeCypressScreenshot(`Scenario 35: Edit Post with x title of more than 301 characters${size}`);
    ...
    it("Scenario 36: Edit Post invalid  with Facebook card - title of more than 301 characters", () => {
      ...
      takeCypressScreenshot(`Scenario 36: Edit Post invalid  with Facebook card - title of more than 301 characters${size}`);
    ...
    it("Scenario 37: Schedule for later with invalid date", () => {
        ...
        // Then the edited post is displayed in the post a message error
        postsPage.checkPostDateError().should("contain", 'Invalid date format, must be YYYY-MM-DD');
        takeCypressScreenshot(`Scenario 37: Schedule for later with invalid date${size}`);
    }); 
