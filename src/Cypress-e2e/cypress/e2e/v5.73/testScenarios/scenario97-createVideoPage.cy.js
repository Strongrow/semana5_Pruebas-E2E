...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Video para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //And, se elige la opción Video
        primaryOptionsPage.getOptionsVideoPage()
        cy.screenshot()
        cy.wait(500) 

        //And, se crea el contenido
        dataMockPage.getOptionsCreateUpvideo()
        cy.screenshot()
        cy.wait(500) 
