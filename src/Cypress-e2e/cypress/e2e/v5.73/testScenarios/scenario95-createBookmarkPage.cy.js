...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido de tipo Bookmark para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido  y publica la page  ", ()=>{
        ...
        //And, se elige la opción Bookmark
        primaryOptionsPage.getOptionsBookmarkPage()
        cy.screenshot()
        cy.wait(500)
        
        //And, se agrega contenido
        dataFakerPage.getOptionsCreateBookmark()
        cy.screenshot()
        cy.wait(500)
