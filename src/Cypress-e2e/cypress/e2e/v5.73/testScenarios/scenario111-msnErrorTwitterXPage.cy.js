...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido equivocado de tipo Xtwiter para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido equivocado  y el mensaje de error   ", ()=>{
        ...
        primaryOptionsPage.getOptionsXPage()
        cy.screenshot()
        cy.wait(500)
