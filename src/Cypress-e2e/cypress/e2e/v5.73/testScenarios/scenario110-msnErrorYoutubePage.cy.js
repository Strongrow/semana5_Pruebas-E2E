...
describe ("Funcionalidad: Crear contenidos en Page", () =>{
    ...
    context("Escenario: muestra la creación del contenido equivocado de tipo Youtube para una  Page " , ()=>{
     it.only("Inicia desde el login, crea el contenido equivocado y muestra mensaje de error  ", ()=>{
        ...
        primaryOptionsPage.getOptionsYouTubePage()
        cy.screenshot()
        cy.wait(500)
